...
const { JWT_SECRET, JWT_EXPIRES_IN, SESSION_COOKIE_NAME, SESSION_COOKIE_MAX_AGE, NODE_ENV } = require('../config/config');
...
exports.register = async (req, res) => {
    try {
        ...
        // Secret Key checking
        const { REGISTRATION_SECRET_KEY } = require('../config/config');
